...
import type { EntropyRuntimeProxyType, EntropySharedConstraints, EntropySharedOcwMessage, FrameSupportDispatchDispatchInfo, FrameSupportTokensMiscBalanceStatus, PalletDemocracyMetadataOwner, PalletDemocracyVoteAccountVote, PalletDemocracyVoteThreshold, PalletElectionProviderMultiPhaseElectionCompute, PalletElectionProviderMultiPhasePhase, PalletImOnlineSr25519AppSr25519Public, PalletMultisigTimepoint, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsPoolState, PalletStakingExposure, PalletStakingExtensionServerInfo, PalletStakingForcing, PalletStakingValidatorPrefs, SpConsensusGrandpaAppPublic, SpNposElectionsElectionScore, SpRuntimeDispatchError } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    constraints: {
       ...
       **/
      ConstraintsUpdated: AugmentedEvent<ApiType, [AccountId32, EntropySharedConstraints]>;
      /**
       * All new V2 constraints. [constraint_account, constraints]
       **/
      ConstraintsV2Updated: AugmentedEvent<ApiType, [AccountId32, Bytes]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    freeTx: {
       ...
       * transaction fees.
       **/
      ElectricitySpent: AugmentedEvent<ApiType, [AccountId32, Result<Null, SpRuntimeDispatchError>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    propagation: {
       ...
       **/
      MessagesPassed: AugmentedEvent<ApiType, [EntropySharedOcwMessage]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
