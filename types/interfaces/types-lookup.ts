...
import type { AccountId32, Call, H160, H256, MultiAddress, PerU16, Perbill, Percent, WeightV1 } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletRelayerError extends Enum {
    ...
    readonly type: 'Test' | 'NotYourResponsibility' | 'NoResponsibility' | 'AlreadySubmitted' | 'NoThresholdKey' | 'NotRegistering' | 'NotRegistered' | 'InvalidSubgroup' | 'AlreadyConfirmed' | 'NotInSigningGroup' | 'InvalidValidatorId' | 'IpAddressError' | 'SigningGroupError' | 'NoSyncedValidators';
  }
