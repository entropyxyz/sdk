...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    readonly id: EntropyRuntimeHoldReason;
    ...
    constraints: {
       ...
       * constraints on.
       **/
      activeArchitectures: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: EntropySharedConstraintsArch | 'Evm' | 'Btc' | number | Uint8Array) => Observable<Option<Null>>, [AccountId32, EntropySharedConstraintsArch]> & QueryableStorageEntry<ApiType, [AccountId32, EntropySharedConstraintsArch]>;
      /**
       ...
       **/
      btcAcl: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<EntropySharedConstraintsAcl>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Stores the EVM ACL of each user
       **/
      evmAcl: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<{
    ...
    readonly allowNullRecipient: bool;
       ...
       **/
      v2Bytecode: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<Bytes>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    relayer: {
      dkg: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<Bytes>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      registered: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletRelayerRegisteredInfo>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
