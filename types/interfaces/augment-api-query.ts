...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    constraints: {
       ...
       * constraints on.
       **/
      activeArchitectures: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: EntropySharedConstraintsArch | 'Evm' | 'Btc' | 'Generic' | number | Uint8Array) => Observable<Option<Null>>, [AccountId32, EntropySharedConstraintsArch]> & QueryableStorageEntry<ApiType, [AccountId32, EntropySharedConstraintsArch]>;
      /**
       ...
       **/
      btcAcl: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<EntropySharedConstraintsAclH256>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Stores the EVM ACL of each user
       **/
      evmAcl: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<EntropySharedConstraintsAclH160>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    relayer: {
      ...
      messages: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<EntropySharedMessage>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      pending: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<EntropySharedMessage>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
