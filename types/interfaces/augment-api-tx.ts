...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    constraints: {
       ...
       * TODO update weights
       **/
      updateConstraints: AugmentedSubmittable<
        (
          sigReqAccount: AccountId32 | string | Uint8Array,
          newConstraints:
            | EntropySharedConstraints
            | { evmAcl?: any; btcAcl?: any }
            | string
            | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
    ...
    freeTx: {
       ...
       **/
      callUsingElectricity: AugmentedSubmittable<
        (
       ...
       **/
      giveZaps: AugmentedSubmittable<
        (
          recipient: AccountId32 | string | Uint8Array,
          cells: u32 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, u32]
      >
      /**
       ...
       **/
      setBatteryCount: AugmentedSubmittable<
        (
          account: AccountId32 | string | Uint8Array,
          batteryCount: u32 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, u32]
      >
      /**
      ...
      setIndividualElectricityEraLimit: AugmentedSubmittable<
        (
          maxCells: Option<u32> | null | Uint8Array | u32 | AnyNumber
        ) => SubmittableExtrinsic<ApiType>,
        [Option<u32>]
      >
      /**
    ...
    relayer: {
       ...
       **/
      confirmDone: AugmentedSubmittable<
        (
          blockNumber: u32 | AnyNumber | Uint8Array,
          failures: Vec<u32> | (u32 | AnyNumber | Uint8Array)[]
        ) => SubmittableExtrinsic<ApiType>,
        [u32, Vec<u32>]
      >
      /**
      ...
      confirmRegister: AugmentedSubmittable<
        ...
        [AccountId32, u8]
      >
      prepTransaction: AugmentedSubmittable<
        (
          sigRequest:
            | EntropySharedSigRequest
            | { sigHash?: any }
      ...
      register: AugmentedSubmittable<
        (
          constraintAccount: AccountId32 | string | Uint8Array,
          initialConstraints:
            | Option<EntropySharedConstraints>
            | null
            | Uint8Array
            | EntropySharedConstraints
            | { evmAcl?: any; btcAcl?: any }
        ...
        [AccountId32, Option<EntropySharedConstraints>]
      >
      /**
    ...
    slashing: {
       ...
       **/
      demoOffence: AugmentedSubmittable<
        (
          offenders: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]
        ) => SubmittableExtrinsic<ApiType>,
        [Vec<AccountId32>]
      >
      /**
    ...
    stakingExtension: {
      ...
      validate: AugmentedSubmittable<
        ...
        [PalletStakingValidatorPrefs, Bytes, AccountId32, U8aFixed]
      >
      /**
