...
import type { AccountId32, Call, H256, MultiAddress, Perbill, Percent, WeightV1 } from '@polkadot/types/interfaces/runtime';
import type { EntropyRuntimeOriginCaller, EntropyRuntimeProxyType, EntropyRuntimeSessionKeys, EntropySharedConstraints, EntropySharedSigRequest, FrameSupportScheduleMaybeHashed, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletElectionProviderMultiPhaseRawSolution, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletElectionsPhragmenRenouncing, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PalletMultisigTimepoint, PalletNominationPoolsBondExtra, PalletNominationPoolsConfigOpAccountId32, PalletNominationPoolsConfigOpU128, PalletNominationPoolsConfigOpU32, PalletNominationPoolsPoolState, PalletSocietyJudgement, PalletStakingPalletConfigOpPerbill, PalletStakingPalletConfigOpPercent, PalletStakingPalletConfigOpU128, PalletStakingPalletConfigOpU32, PalletStakingRewardDestination, PalletStakingValidatorPrefs, PalletVestingVestingInfo, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusSlotsEquivocationProof, SpFinalityGrandpaEquivocationProof, SpNposElectionsElectionScore, SpNposElectionsSupport, SpRuntimeHeader, SpSessionMembershipProof, SpTransactionStorageProofTransactionStorageProof } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    constraints: {
       ...
       * TODO update weights
       **/
      updateConstraints: AugmentedSubmittable<(sigReqAccount: AccountId32 | string | Uint8Array, newConstraints: EntropySharedConstraints | { evmAcl?: any; btcAcl?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, EntropySharedConstraints]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    freeTx: {
       ...
       **/
      callUsingElectricity: AugmentedSubmittable<(call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Call]>;
      /**
       * Give the recipient some zaps
       **/
      giveZaps: AugmentedSubmittable<(recipient: AccountId32 | string | Uint8Array, cells: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, u32]>;
      /**
       * Set the number of batteries an account has. Since they are rechargable, setting (vs
       * giving) makes more sense in this context.
       **/
      setBatteryCount: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array, batteryCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, u32]>;
      /**
       * Put a cap on the number of cells individual accounts can use per era.
       * To disable electricity temporary, set this to `0`.
       **/
      setIndividualElectricityEraLimit: AugmentedSubmittable<(maxCells: Option<u32> | null | Uint8Array | u32 | AnyNumber) => SubmittableExtrinsic<ApiType>, [Option<u32>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    proxy: {
       ...
       **/
      createPure: AugmentedSubmittable<(proxyType: EntropyRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [EntropyRuntimeProxyType, u32, u16]>;
      /**
       ...
       **/
      killPure: AugmentedSubmittable<(spawner: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, proxyType: EntropyRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, EntropyRuntimeProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       ...
       **/
      proxy: AugmentedSubmittable<(real: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, forceProxyType: Option<EntropyRuntimeProxyType> | null | Uint8Array | EntropyRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, Option<EntropyRuntimeProxyType>, Call]>;
      /**
       ...
       * - `call`: The call to be made by the `real` account.
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, real: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, forceProxyType: Option<EntropyRuntimeProxyType> | null | Uint8Array | EntropyRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, MultiAddress, Option<EntropyRuntimeProxyType>, Call]>;
      /**
    ...
    relayer: {
       ...
       **/
      confirmDone: AugmentedSubmittable<(blockNumber: u32 | AnyNumber | Uint8Array, failures: Vec<u32> | (u32 | AnyNumber | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [u32, Vec<u32>]>;
      /**
       ...
       **/
      confirmRegister: AugmentedSubmittable<(sigReqAccount: AccountId32 | string | Uint8Array, signingSubgroup: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, u8]>;
      prepTransaction: AugmentedSubmittable<(sigRequest: EntropySharedSigRequest | { sigHash?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [EntropySharedSigRequest]>;
      /**
       ...
       **/
      register: AugmentedSubmittable<(constraintAccount: AccountId32 | string | Uint8Array, initialConstraints: Option<EntropySharedConstraints> | null | Uint8Array | EntropySharedConstraints | { evmAcl?: any; btcAcl?: any } | string) => SubmittableExtrinsic<ApiType>, [AccountId32, Option<EntropySharedConstraints>]>;
      /**
       * Signals that a user wants to swap our their keys
       **/
      swapKeys: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    session: {
       ...
       * # </weight>
       **/
      setKeys: AugmentedSubmittable<(keys: EntropyRuntimeSessionKeys | { grandpa?: any; babe?: any; imOnline?: any; authorityDiscovery?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [EntropyRuntimeSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    slashing: {
       ...
       **/
      demoOffence: AugmentedSubmittable<(offenders: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<AccountId32>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    stakingExtension: {
       ...
       **/
      changeEndpoint: AugmentedSubmittable<(endpoint: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes]>;
      /**
       ...
       **/
      changeThresholdAccounts: AugmentedSubmittable<(tssAccount: AccountId32 | string | Uint8Array, x25519PublicKey: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, U8aFixed]>;
      /**
       * Let a validator declare if their kvdb is synced or not synced
       * `synced`: State of validator's kvdb
       **/
      declareSynced: AugmentedSubmittable<(synced: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [bool]>;
      /**
       ...
       **/
      validate: AugmentedSubmittable<(prefs: PalletStakingValidatorPrefs | { commission?: any; blocked?: any } | string | Uint8Array, endpoint: Bytes | string | Uint8Array, tssAccount: AccountId32 | string | Uint8Array, x25519PublicKey: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletStakingValidatorPrefs, Bytes, AccountId32, U8aFixed]>;
      /**
    ...
    utility: {
       ...
       * # </weight>
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: EntropyRuntimeOriginCaller | { system: any } | { Void: any } | { Council: any } | { TechnicalCommittee: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [EntropyRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
