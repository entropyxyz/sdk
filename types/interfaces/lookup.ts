...
export default {
   ...
   **/
  PalletRelayerError: {
    _enum: ['Test', 'NotYourResponsibility', 'NoResponsibility', 'AlreadySubmitted', 'NoThresholdKey', 'NotRegistering', 'NotRegistered', 'InvalidSubgroup', 'AlreadyConfirmed', 'NotInSigningGroup', 'InvalidValidatorId', 'IpAddressError', 'SigningGroupError', 'NoSyncedValidators']
  },
  /**
