...
import type { EntropyRuntimeProxyType, FrameSupportDispatchDispatchInfo, FrameSupportScheduleLookupError, FrameSupportTokensMiscBalanceStatus, PalletDemocracyVoteAccountVote, PalletDemocracyVoteThreshold, PalletElectionProviderMultiPhaseElectionCompute, PalletImOnlineSr25519AppSr25519Public, PalletMultisigTimepoint, PalletNominationPoolsPoolState, PalletStakingExposure, PalletStakingExtensionServerInfo, PalletStakingValidatorPrefs, SpFinalityGrandpaAppPublic, SpNposElectionsElectionScore, SpRuntimeDispatchError, SubstrateCommonConstraints, SubstrateCommonMessage } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    constraints: {
       ...
       **/
      ConstraintsUpdated: AugmentedEvent<ApiType, [AccountId32, SubstrateCommonConstraints]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    propagation: {
       ...
       * parameters. [messages]
       **/
      MessagesPassed: AugmentedEvent<ApiType, [Vec<SubstrateCommonMessage>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    relayer: {
       ...
       **/
      SignatureRequested: AugmentedEvent<ApiType, [SubstrateCommonMessage]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
