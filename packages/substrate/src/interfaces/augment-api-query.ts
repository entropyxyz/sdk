...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    constraints: {
       ...
       * constraints on.
       **/
      activeArchitectures: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: SubstrateCommonConstraintsArch | 'Evm' | 'Btc' | 'Generic' | number | Uint8Array) => Observable<Option<Null>>, [AccountId32, SubstrateCommonConstraintsArch]> & QueryableStorageEntry<ApiType, [AccountId32, SubstrateCommonConstraintsArch]>;
      /**
       ...
       **/
      allowedToModifyConstraints: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<Null>>, [AccountId32, AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32, AccountId32]>;
      /**
       * Stores the BTC ACL of each user
       **/
      btcAcl: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<SubstrateCommonConstraintsAclH256>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Stores the EVM ACL of each user
       **/
      evmAcl: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<SubstrateCommonConstraintsAclH160>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    freeTx: {
       ...
       **/
      electricalAccount: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletFreeTxElectricalPanel>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      maxUserElectricityUsagePerEra: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    relayer: {
      failures: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<Vec<u32>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      messages: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<SubstrateCommonMessage>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      pending: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<SubstrateCommonMessage>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      registered: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<bool>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      registering: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletRelayerRegisteringDetails>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      responsibility: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<AccountId32>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      unresponsive: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<u32>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<EntropyRuntimeSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, EntropyRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    stakingExtension: {
       ...
       **/
      signingGroups: AugmentedQuery<ApiType, (arg: u8 | AnyNumber | Uint8Array) => Observable<Option<Vec<AccountId32>>>, [u8]> & QueryableStorageEntry<ApiType, [u8]>;
      /**
       ...
       * shares over HTTP.
       **/
      thresholdServers: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletStakingExtensionServerInfo>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      thresholdToStash: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<AccountId32>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
