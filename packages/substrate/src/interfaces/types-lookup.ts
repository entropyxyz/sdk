...
import type { AccountId32, Call, H160, H256, MultiAddress, PerU16, Perbill, Percent, Weight } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletPropagationEvent extends Enum {
    ...
    readonly asMessagesPassed: Vec<SubstrateCommonMessage>;
    readonly type: 'MessagesPassed';
  }

  /** @name SubstrateCommonMessage (98) */
  interface SubstrateCommonMessage extends Struct {
    readonly sigRequest: SubstrateCommonSigRequest;
    readonly account: Bytes;
    readonly ipAddresses: Vec<Bytes>;
  }

  /** @name SubstrateCommonSigRequest (99) */
  interface SubstrateCommonSigRequest extends Struct {
  ...
  interface PalletRelayerEvent extends Enum {
    ...
    readonly asSignatureRequested: SubstrateCommonMessage;
  ...
  interface PalletConstraintsEvent extends Enum {
    ...
    readonly asConstraintsUpdated: ITuple<[AccountId32, SubstrateCommonConstraints]>;
    readonly type: 'ConstraintsUpdated';
  }

  /** @name SubstrateCommonConstraints (105) */
  interface SubstrateCommonConstraints extends Struct {
    readonly evmAcl: Option<SubstrateCommonConstraintsAclH160>;
    readonly btcAcl: Option<SubstrateCommonConstraintsAclH256>;
  }

  /** @name SubstrateCommonConstraintsAclH160 (107) */
  interface SubstrateCommonConstraintsAclH160 extends Struct {
    readonly addresses: Vec<H160>;
    readonly kind: SubstrateCommonConstraintsAclAclKind;
    readonly allowNullRecipient: bool;
  }

  /** @name SubstrateCommonConstraintsAclAclKind (111) */
  interface SubstrateCommonConstraintsAclAclKind extends Enum {
    readonly isAllow: boolean;
    readonly isDeny: boolean;
    readonly type: 'Allow' | 'Deny';
  }

  /** @name SubstrateCommonConstraintsAclH256 (113) */
  interface SubstrateCommonConstraintsAclH256 extends Struct {
  ...
  interface PalletRelayerCall extends Enum {
    ...
    readonly asRegister: {
      ...
      readonly initialConstraints: Option<SubstrateCommonConstraints>;
    } & Struct;
    ...
    readonly type: 'PrepTransaction' | 'Register' | 'SwapKeys' | 'ConfirmRegister' | 'ConfirmDone';
  }
  ...
  interface PalletConstraintsCall extends Enum {
    ...
    readonly asUpdateConstraints: {
      readonly sigReqAccount: AccountId32;
      readonly newConstraints: SubstrateCommonConstraints;
    } & Struct;
  ...
  interface PalletRelayerRegisteringDetails extends Struct {
    ...
    readonly constraints: Option<SubstrateCommonConstraints>;
  }
  ...
  interface PalletRelayerError extends Enum {
    ...
    readonly isSigningGroupError: boolean;
    readonly type: 'Test' | 'NotYourResponsibility' | 'NoResponsibility' | 'AlreadySubmitted' | 'NoThresholdKey' | 'NotRegistering' | 'NotRegistered' | 'InvalidSubgroup' | 'AlreadyConfirmed' | 'NotInSigningGroup' | 'InvalidValidatorId' | 'IpAddressError' | 'SigningGroupError';
  }

  /** @name SubstrateCommonConstraintsArch (543) */
  interface SubstrateCommonConstraintsArch extends Enum {
  ...
  interface PalletConstraintsError extends Enum {
    ...
    readonly type: 'NotAuthorized' | 'ArchitectureDisabled' | 'AclLengthExceeded';
  }
