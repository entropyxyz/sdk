...
export default class Entropy {
  ...
  async #setVerfiyingKeys (): Promise<void> {
    ...
    if (this.account != null) {
      ...
      if (this.account.sigRequestKey != null) {
  ...
  #setReadOnlyStates (): void {
    ...
    } else if ((this.account.sigRequestKey == null) && !this.account.programModKey) {
      this.#allReadOnly = true
    }
  ...
  async register (
    ...
    const account = (params.account != null) || this.account
  ...
  async signTransaction (params: SigTxOps): Promise<unknown> {
    ...
    return await this.signingManager.signTransaction(params)
  }
  ...
  async sign (params: SigOps): Promise<Uint8Array> {
    ...
    return await this.signingManager.sign(params)
  }
}
