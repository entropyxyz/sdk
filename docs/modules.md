...
- [extrinsic](modules/extrinsic.md)
...
- [signing/adapters/eth](modules/signing_adapters_eth.md)
- [signing/adapters/types](modules/signing_adapters_types.md)
- [types](modules/types.md)
- [utils](modules/utils.md)
- [utils/crypto](modules/utils_crypto.md)
