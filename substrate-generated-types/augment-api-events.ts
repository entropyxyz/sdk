...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    programs: {
       ...
       **/
      ProgramCreated: AugmentedEvent<ApiType, [deployer: AccountId32, programHash: H256, configurationSchema: Bytes, auxiliaryDataSchema: Bytes, oracleDataPointer: Bytes], { deployer: AccountId32, programHash: H256, configurationSchema: Bytes, auxiliaryDataSchema: Bytes, oracleDataPointer: Bytes }>;
      /**
