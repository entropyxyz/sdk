...
declare module '@polkadot/api-base/types/errors' {
  interface AugmentedErrors<ApiType extends ApiTypes> {
    ...
    parameters: {
       ...
       **/
      OneChangePerSession: AugmentedError<ApiType>;
      /**
       * Signers can only change by one at a time
       **/
      SignerDiffTooLarge: AugmentedError<ApiType>;
      /**
       * Threhsold has to be more than 0
       **/
      ThrehsoldTooLow: AugmentedError<ApiType>;
      /**
       * Threshold can not be greater then signers
       **/
      ThresholdGreaterThenSigners: AugmentedError<ApiType>;
      /**
    ...
    registry: {
      ...
      Bip32AccountDerivationFailed: AugmentedError<ApiType>;
      CannotFindValidatorInfo: AugmentedError<ApiType>;
      InvalidBip32DerivationPath: AugmentedError<ApiType>;
      IpAddressError: AugmentedError<ApiType>;
      JumpStartNotCompleted: AugmentedError<ApiType>;
      JumpStartNotInProgress: AugmentedError<ApiType>;
      JumpStartProgressNotReady: AugmentedError<ApiType>;
      MismatchedVerifyingKey: AugmentedError<ApiType>;
      NoProgramSet: AugmentedError<ApiType>;
      NoRegisteringFromParentKey: AugmentedError<ApiType>;
      NotAuthorized: AugmentedError<ApiType>;
      NotEnoughValidatorsForJumpStart: AugmentedError<ApiType>;
    ...
    stakingExtension: {
      AlreadyConfirmed: AugmentedError<ApiType>;
      EndpointTooLong: AugmentedError<ApiType>;
      InvalidValidatorId: AugmentedError<ApiType>;
      NoBond: AugmentedError<ApiType>;
      NoChangingThresholdAccountWhenSigner: AugmentedError<ApiType>;
      NotController: AugmentedError<ApiType>;
      NoThresholdKey: AugmentedError<ApiType>;
      NotNextSigner: AugmentedError<ApiType>;
      NoUnbondingWhenNextSigner: AugmentedError<ApiType>;
      NoUnbondingWhenSigner: AugmentedError<ApiType>;
      NoUnnominatingWhenNextSigner: AugmentedError<ApiType>;
      NoUnnominatingWhenSigner: AugmentedError<ApiType>;
      ReshareNotInProgress: AugmentedError<ApiType>;
      SigningGroupError: AugmentedError<ApiType>;
      TooManyPendingAttestations: AugmentedError<ApiType>;
