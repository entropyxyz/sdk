...
declare module '@polkadot/types/lookup' {
  ...
  /** @name EntropyRuntimeProxyType (89) */
  ...
  /** @name PalletNominationPoolsEvent (97) */
  ...
  /** @name PalletNominationPoolsPoolState (98) */
  ...
  /** @name PalletNominationPoolsCommissionChangeRate (101) */
  ...
  interface PalletRelayerEvent extends Enum {
    ...
    readonly type: 'SignalRegister' | 'AccountRegistering' | 'AccountRegistered' | 'FailedRegistration' | 'RegistrationCancelled' | 'ConfirmedDone';
  }
  ...
  /** @name PalletProgramsEvent (106) */
  interface PalletProgramsEvent extends Enum {
    readonly isProgramUpdated: boolean;
    readonly asProgramUpdated: {
      readonly programModificationAccount: AccountId32;
      readonly newProgram: Bytes;
    } & Struct;
    readonly type: 'ProgramUpdated';
  }

  /** @name PalletTransactionPauseModuleEvent (107) */
  ...
  /** @name PalletPropagationEvent (109) */
  ...
  /** @name EntropySharedOcwMessage (110) */
  ...
  /** @name EntropySharedValidatorInfo (113) */
  ...
  /** @name SpConsensusSlotsEquivocationProof (140) */
  ...
  /** @name EntropyRuntimeNposSolution16 (155) */
  ...
  /** @name PalletStakingPalletConfigOpU128 (216) */
  ...
  /** @name PalletStakingPalletConfigOpU32 (217) */
  ...
  /** @name PalletStakingPalletConfigOpPercent (218) */
  ...
  /** @name PalletStakingPalletConfigOpPerbill (219) */
  ...
  /** @name PalletStakingExtensionCall (220) */
  ...
  /** @name EntropyRuntimeSessionKeys (222) */
  ...
  /** @name PalletDemocracyConviction (227) */
  ...
  /** @name PalletElectionsPhragmenCall (231) */
  ...
  /** @name PalletElectionsPhragmenRenouncing (232) */
  ...
  /** @name PalletVestingVestingInfo (294) */
  ...
  /** @name PalletNominationPoolsCall (307) */
  ...
  /** @name PalletNominationPoolsBondExtra (308) */
  ...
  /** @name PalletNominationPoolsConfigOpU128 (309) */
  ...
  /** @name PalletNominationPoolsConfigOpU32 (310) */
  ...
  /** @name PalletNominationPoolsConfigOpPerbill (311) */
  ...
  /** @name PalletNominationPoolsConfigOpAccountId32 (312) */
  ...
  /** @name PalletNominationPoolsClaimPermission (313) */
  ...
  interface PalletRelayerCall extends Enum {
    ...
    readonly type: 'Register' | 'PruneRegistration' | 'ConfirmRegister';
  }

  /** @name EntropySharedKeyVisibility (315) */
  ...
  /** @name PalletProgramsCall (318) */
  interface PalletProgramsCall extends Enum {
    readonly isUpdateProgram: boolean;
    readonly asUpdateProgram: {
      readonly sigReqAccount: AccountId32;
      readonly newProgram: Bytes;
    } & Struct;
    readonly type: 'UpdateProgram';
  }

  /** @name PalletTransactionPauseModuleCall (319) */
  ...
  /** @name PalletPropagationCall (321) */
  type PalletPropagationCall = Null;

  /** @name EntropyRuntimeOriginCaller (322) */
  ...
  /** @name SpCoreSr25519VrfVrfSignature (336) */
  ...
  /** @name EntropyRuntimeRuntimeHoldReason (355) */
  type EntropyRuntimeRuntimeHoldReason = Null;

  /** @name PalletBalancesIdAmount (358) */
  ...
  /** @name PalletElectionProviderMultiPhaseReadySolution (363) */
  ...
  /** @name PalletElectionProviderMultiPhaseRoundSnapshot (365) */
  interface PalletElectionProviderMultiPhaseRoundSnapshot extends Struct {
    readonly voters: Vec<ITuple<[AccountId32, u64, Vec<AccountId32>]>>;
    readonly targets: Vec<AccountId32>;
  }

  /** @name PalletElectionProviderMultiPhaseSignedSignedSubmission (372) */
  ...
  /** @name PalletElectionProviderMultiPhaseError (373) */
  ...
  /** @name PalletStakingNominations (379) */
  ...
  /** @name PalletStakingEraRewardPoints (383) */
  interface PalletStakingEraRewardPoints extends Struct {
    readonly total: u32;
    readonly individual: BTreeMap<AccountId32, u32>;
  }

  /** @name PalletStakingUnappliedSlash (388) */
  ...
  /** @name PalletStakingSlashingSlashingSpans (390) */
  ...
  /** @name PalletStakingSlashingSpanRecord (391) */
  ...
  /** @name PalletStakingExtensionError (395) */
  ...
  /** @name SpCoreCryptoKeyTypeId (399) */
  interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (400) */
  ...
  /** @name PalletDemocracyReferendumInfo (406) */
  ...
  /** @name PalletDemocracyReferendumStatus (407) */
  ...
  /** @name PalletDemocracyVoteVoting (409) */
  ...
  /** @name PalletDemocracyDelegations (413) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (414) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (417) */
  ...
  /** @name PalletCollectiveVotes (419) */
  ...
  /** @name PalletCollectiveError (420) */
  ...
  /** @name PalletElectionsPhragmenSeatHolder (424) */
  ...
  /** @name PalletElectionsPhragmenVoter (425) */
  ...
  /** @name PalletElectionsPhragmenError (426) */
  ...
  /** @name PalletMembershipError (428) */
  ...
  /** @name SpStakingOffenceOffenceDetails (445) */
  ...
  /** @name PalletRecoveryActiveRecovery (463) */
  ...
  /** @name PalletVestingReleases (467) */
  ...
  /** @name PalletSchedulerScheduled (471) */
  ...
  /** @name PalletTransactionStorageTransactionInfo (498) */
  ...
  /** @name PalletTransactionStorageError (500) */
  ...
  /** @name PalletBagsListListNode (501) */
  ...
  /** @name PalletBagsListListBag (502) */
  ...
  /** @name PalletNominationPoolsPoolMember (506) */
  ...
  /** @name PalletNominationPoolsBondedPoolInner (511) */
  ...
  /** @name PalletNominationPoolsCommission (512) */
  ...
  /** @name PalletNominationPoolsPoolRoles (515) */
  ...
  /** @name PalletNominationPoolsRewardPool (516) */
  ...
  /** @name PalletNominationPoolsSubPools (517) */
  ...
  /** @name PalletNominationPoolsUnbondPool (518) */
  interface PalletNominationPoolsUnbondPool extends Struct {
    readonly points: u128;
    readonly balance: u128;
  }

  /** @name PalletNominationPoolsError (524) */
  ...
  /** @name PalletNominationPoolsDefensiveError (525) */
  ...
  /** @name PalletRelayerRegisteringDetails (526) */
  ...
  /** @name PalletRelayerRegisteredInfo (528) */
  interface PalletRelayerRegisteredInfo extends Struct {
    readonly keyVisibility: EntropySharedKeyVisibility;
    readonly verifyingKey: Bytes;
  }

  /** @name PalletRelayerError (529) */
  interface PalletRelayerError extends Enum {
    ...
    readonly type: 'AlreadySubmitted' | 'NoThresholdKey' | 'NotRegistering' | 'NotRegistered' | 'InvalidSubgroup' | 'AlreadyConfirmed' | 'NotInSigningGroup' | 'IpAddressError' | 'SigningGroupError' | 'NoSyncedValidators' | 'MaxProgramLengthExceeded' | 'NoVerifyingKey';
  }

  /** @name PalletProgramsError (530) */
  interface PalletProgramsError extends Enum {
    readonly isNotAuthorized: boolean;
    readonly isProgramLengthExceeded: boolean;
    readonly type: 'NotAuthorized' | 'ProgramLengthExceeded';
  }

  /** @name PalletTransactionPauseModuleError (531) */
  ...
  /** @name PalletFreeTxElectricalPanel (532) */
  ...
  /** @name PalletFreeTxValidateElectricityPayment (548) */
  type PalletFreeTxValidateElectricityPayment = Null;

  /** @name PalletRelayerValidateConfirmRegistered (549) */
  type PalletRelayerValidateConfirmRegistered = Null;

  /** @name EntropyRuntimeRuntime (550) */
