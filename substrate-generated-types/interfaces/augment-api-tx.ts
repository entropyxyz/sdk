...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    freeTx: {
      ...
      /**
       * See [`Pallet::set_individual_electricity_era_limit`].
       **/
    ...
    slashing: {
      /**
       * See [`Pallet::demo_offence`].
       **/
      demoOffence: AugmentedSubmittable<(reporter: AccountId32 | string | Uint8Array, offenders: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [AccountId32, Vec<AccountId32>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
