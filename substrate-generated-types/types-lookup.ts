...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletStakingExtensionEvent extends Enum {
    ...
    readonly isValidatorSubgroupsRotated: boolean;
    readonly asValidatorSubgroupsRotated: ITuple<[Vec<Vec<AccountId32>>, Vec<Vec<AccountId32>>]>;
    readonly isSignerConfirmed: boolean;
    readonly asSignerConfirmed: AccountId32;
    readonly isSignersRotation: boolean;
    readonly asSignersRotation: Vec<AccountId32>;
    readonly isAttestationCheckQueued: boolean;
    readonly asAttestationCheckQueued: AccountId32;
    readonly type: 'EndpointChanged' | 'NodeInfoChanged' | 'ThresholdAccountChanged' | 'NodeInfoRemoved' | 'ValidatorSyncStatus' | 'ValidatorSubgroupsRotated' | 'SignerConfirmed' | 'SignersRotation' | 'AttestationCheckQueued';
  }
  ...
  interface PalletStakingExtensionServerInfo extends Struct {
    ...
    readonly provisioningCertificationKey: Bytes;
  }
  ...
  /** @name PalletElectionsPhragmenEvent (63) */
  ...
  /** @name PalletImOnlineSr25519AppSr25519Public (75) */
  interface PalletImOnlineSr25519AppSr25519Public extends SpCoreSr25519Public {}

  /** @name SpCoreSr25519Public (76) */
  interface SpCoreSr25519Public extends U8aFixed {}

  /** @name SpStakingExposure (79) */
  ...
  /** @name SpStakingIndividualExposure (82) */
  interface SpStakingIndividualExposure extends Struct {
    readonly who: AccountId32;
    readonly value: Compact<u128>;
  }

  /** @name PalletOffencesEvent (83) */
  ...
  /** @name EntropyRuntimeProxyType (94) */
  ...
  /** @name PalletNominationPoolsEvent (102) */
  ...
  /** @name PalletNominationPoolsPoolState (103) */
  ...
  /** @name PalletRegistryEvent (109) */
  interface PalletRegistryEvent extends Enum {
    readonly isStartedNetworkJumpStart: boolean;
    readonly isFinishedNetworkJumpStart: boolean;
    readonly isJumpStartConfirmation: boolean;
    readonly asJumpStartConfirmation: ITuple<[AccountId32, u8]>;
    readonly isAccountRegistered: boolean;
    readonly asAccountRegistered: ITuple<[AccountId32, Bytes]>;
    readonly isProgramInfoChanged: boolean;
    readonly asProgramInfoChanged: ITuple<[AccountId32, Vec<PalletRegistryProgramInstance>]>;
    readonly isProgramModificationAccountChanged: boolean;
    readonly asProgramModificationAccountChanged: ITuple<[AccountId32, AccountId32, Bytes]>;
    readonly type: 'StartedNetworkJumpStart' | 'FinishedNetworkJumpStart' | 'JumpStartConfirmation' | 'AccountRegistered' | 'ProgramInfoChanged' | 'ProgramModificationAccountChanged';
  }

  /** @name PalletRegistryProgramInstance (111) */
  interface PalletRegistryProgramInstance extends Struct {
    readonly programPointer: H256;
    readonly programConfig: Bytes;
  }

  /** @name PalletSlashingEvent (113) */
  interface PalletSlashingEvent extends Enum {
    readonly isNoteReport: boolean;
    readonly asNoteReport: ITuple<[AccountId32, AccountId32]>;
    readonly isUnresponsivenessOffence: boolean;
    readonly asUnresponsivenessOffence: Vec<ITuple<[AccountId32, SpStakingExposure]>>;
    readonly type: 'NoteReport' | 'UnresponsivenessOffence';
  }

  /** @name PalletProgramsEvent (114) */
  interface PalletProgramsEvent extends Enum {
    readonly isProgramCreated: boolean;
    readonly asProgramCreated: {
      readonly deployer: AccountId32;
      readonly programHash: H256;
      readonly configurationSchema: Bytes;
      readonly auxiliaryDataSchema: Bytes;
      readonly oracleDataPointer: Bytes;
      readonly versionNumber: u8;
    } & Struct;
  ...
  /** @name PalletPropagationEvent (116) */
  interface PalletPropagationEvent extends Enum {
    ...
    readonly isKeyReshareMessagePassed: boolean;
    readonly asKeyReshareMessagePassed: EntropySharedOcwMessageReshare;
    readonly isAttestationRequestMessagePassed: boolean;
    readonly asAttestationRequestMessagePassed: EntropySharedOcwMessageAttestationRequest;
    readonly isKeyRotatesMessagePassed: boolean;
    readonly asKeyRotatesMessagePassed: u32;
    readonly type: 'DkgMessagePassed' | 'ProactiveRefreshMessagePassed' | 'KeyReshareMessagePassed' | 'AttestationRequestMessagePassed' | 'KeyRotatesMessagePassed';
  }

  /** @name EntropySharedOcwMessageDkg (117) */
  interface EntropySharedOcwMessageDkg extends Struct {
    readonly blockNumber: u32;
    readonly validatorsInfo: Vec<EntropySharedValidatorInfo>;
  }

  /** @name EntropySharedValidatorInfo (119) */
  ...
  /** @name EntropySharedOcwMessageProactiveRefresh (120) */
  interface EntropySharedOcwMessageProactiveRefresh extends Struct {
    readonly blockNumber: u32;
    readonly validatorsInfo: Vec<EntropySharedValidatorInfo>;
    readonly proactiveRefreshKeys: Vec<Bytes>;
  }

  /** @name EntropySharedOcwMessageReshare (122) */
  interface EntropySharedOcwMessageReshare extends Struct {
    readonly newSigner: Bytes;
    readonly blockNumber: u32;
  }

  /** @name EntropySharedOcwMessageAttestationRequest (123) */
  interface EntropySharedOcwMessageAttestationRequest extends Struct {
    readonly tssAccountIds: Vec<U8aFixed>;
  }

  /** @name PalletParametersModuleEvent (125) */
  interface PalletParametersModuleEvent extends Enum {
    readonly isRequestLimitChanged: boolean;
    readonly asRequestLimitChanged: {
      readonly requestLimit: u32;
    } & Struct;
    readonly isMaxInstructionsPerProgramsChanged: boolean;
    readonly asMaxInstructionsPerProgramsChanged: {
      readonly maxInstructionsPerPrograms: u64;
    } & Struct;
    readonly isSignerInfoChanged: boolean;
    readonly asSignerInfoChanged: {
      readonly signerInfo: PalletParametersModuleSignersSize;
    } & Struct;
    readonly isAcceptedMrtdValuesChanged: boolean;
    readonly asAcceptedMrtdValuesChanged: {
      readonly acceptedMrtdValues: Vec<Bytes>;
    } & Struct;
    readonly type: 'RequestLimitChanged' | 'MaxInstructionsPerProgramsChanged' | 'SignerInfoChanged' | 'AcceptedMrtdValuesChanged';
  }

  /** @name PalletParametersModuleSignersSize (126) */
  interface PalletParametersModuleSignersSize extends Struct {
    readonly threshold: u8;
    readonly totalSigners: u8;
    readonly lastSessionChange: u32;
  }

  /** @name PalletOracleModuleEvent (129) */
  type PalletOracleModuleEvent = Null;

  /** @name PalletAttestationEvent (130) */
  interface PalletAttestationEvent extends Enum {
    readonly isAttestationMade: boolean;
    readonly type: 'AttestationMade';
  }
  ...
  /** @name PalletBalancesAdjustmentDirection (171) */
  ...
  /** @name PalletElectionProviderMultiPhaseCall (172) */
  ...
  /** @name PalletElectionProviderMultiPhaseRawSolution (173) */
  ...
  /** @name EntropyRuntimeNposCompactSolution16 (174) */
  interface EntropyRuntimeNposCompactSolution16 extends Struct {
  ...
  /** @name PalletElectionProviderMultiPhaseSolutionOrSnapshotSize (225) */
  interface PalletElectionProviderMultiPhaseSolutionOrSnapshotSize extends Struct {
    readonly voters: Compact<u32>;
    readonly targets: Compact<u32>;
  }

  /** @name SpNposElectionsSupport (229) */
  interface SpNposElectionsSupport extends Struct {
    readonly total: u128;
    readonly voters: Vec<ITuple<[AccountId32, u128]>>;
  }

  /** @name PalletStakingPalletCall (231) */
  ...
  /** @name PalletStakingPalletConfigOpU128 (235) */
  ...
  /** @name PalletStakingPalletConfigOpU32 (236) */
  ...
  /** @name PalletStakingPalletConfigOpPercent (237) */
  ...
  /** @name PalletStakingPalletConfigOpPerbill (238) */
  ...
  /** @name PalletStakingUnlockChunk (243) */
  interface PalletStakingUnlockChunk extends Struct {
    readonly value: Compact<u128>;
    readonly era: Compact<u32>;
  }

  /** @name PalletStakingExtensionCall (245) */
  interface PalletStakingExtensionCall extends Enum {
    ...
    readonly asValidate: {
      readonly prefs: PalletStakingValidatorPrefs;
      readonly serverInfo: PalletStakingExtensionServerInfo;
    } & Struct;
    readonly isDeclareSynced: boolean;
    readonly asDeclareSynced: {
      readonly synced: bool;
    } & Struct;
    readonly isConfirmKeyReshare: boolean;
    readonly type: 'ChangeEndpoint' | 'ChangeThresholdAccounts' | 'Unbond' | 'Chill' | 'WithdrawUnbonded' | 'Validate' | 'DeclareSynced' | 'ConfirmKeyReshare';
  }
  ...
  /** @name EntropyRuntimeSessionKeys (247) */
  ...
  /** @name SpAuthorityDiscoveryAppPublic (248) */
  ...
  /** @name FrameSupportPreimagesBounded (250) */
  ...
  /** @name PalletDemocracyConviction (253) */
  ...
  /** @name SpConsensusGrandpaEquivocationProof (261) */
  interface SpConsensusGrandpaEquivocationProof extends Struct {
    readonly setId: u64;
    readonly equivocation: SpConsensusGrandpaEquivocation;
  }

  /** @name SpConsensusGrandpaEquivocation (262) */
  ...
  /** @name FinalityGrandpaEquivocationPrevote (263) */
  ...
  /** @name FinalityGrandpaPrevote (264) */
  interface FinalityGrandpaPrevote extends Struct {
    readonly targetHash: H256;
    readonly targetNumber: u32;
  }

  /** @name SpConsensusGrandpaAppSignature (265) */
  interface SpConsensusGrandpaAppSignature extends SpCoreEd25519Signature {}

  /** @name SpCoreEd25519Signature (266) */
  interface SpCoreEd25519Signature extends U8aFixed {}

  /** @name FinalityGrandpaEquivocationPrecommit (269) */
  ...
  /** @name FinalityGrandpaPrecommit (270) */
  interface FinalityGrandpaPrecommit extends Struct {
    readonly targetHash: H256;
    readonly targetNumber: u32;
  }

  /** @name PalletTreasuryCall (272) */
  ...
  /** @name PalletImOnlineHeartbeat (275) */
  ...
  /** @name PalletImOnlineSr25519AppSr25519Signature (276) */
  interface PalletImOnlineSr25519AppSr25519Signature extends SpCoreSr25519Signature {}

  /** @name SpCoreSr25519Signature (277) */
  interface SpCoreSr25519Signature extends U8aFixed {}

  /** @name PalletIdentityCall (278) */
  ...
  /** @name PalletIdentityLegacyIdentityInfo (279) */
  ...
  /** @name SpRuntimeMultiSignature (317) */
  ...
  /** @name PalletVestingVestingInfo (322) */
  ...
  /** @name PalletTransactionStorageCall (332) */
  ...
  /** @name PalletNominationPoolsCall (335) */
  ...
  /** @name PalletNominationPoolsBondExtra (336) */
  ...
  /** @name PalletNominationPoolsConfigOpU128 (337) */
  ...
  /** @name PalletNominationPoolsConfigOpU32 (338) */
  ...
  /** @name PalletNominationPoolsConfigOpPerbill (339) */
  ...
  /** @name PalletNominationPoolsConfigOpAccountId32 (340) */
  ...
  /** @name PalletNominationPoolsClaimPermission (341) */
  ...
  /** @name PalletRegistryCall (342) */
  interface PalletRegistryCall extends Enum {
    readonly isJumpStartNetwork: boolean;
    readonly isConfirmJumpStart: boolean;
    readonly asConfirmJumpStart: {
      readonly verifyingKey: Bytes;
    } & Struct;
    readonly isRegister: boolean;
    readonly asRegister: {
      readonly programModificationAccount: AccountId32;
      readonly programsData: Vec<PalletRegistryProgramInstance>;
    } & Struct;
    readonly isChangeProgramInstance: boolean;
    readonly asChangeProgramInstance: {
      readonly verifyingKey: Bytes;
      readonly newProgramInstance: Vec<PalletRegistryProgramInstance>;
    } & Struct;
    readonly isChangeProgramModificationAccount: boolean;
    readonly asChangeProgramModificationAccount: {
      readonly verifyingKey: Bytes;
      readonly newProgramModAccount: AccountId32;
    } & Struct;
    readonly type: 'JumpStartNetwork' | 'ConfirmJumpStart' | 'Register' | 'ChangeProgramInstance' | 'ChangeProgramModificationAccount';
  }

  /** @name PalletSlashingCall (343) */
  type PalletSlashingCall = Null;

  /** @name PalletProgramsCall (344) */
  interface PalletProgramsCall extends Enum {
  ...
  /** @name PalletTransactionPauseModuleCall (345) */
  ...
  /** @name PalletPropagationCall (346) */
  type PalletPropagationCall = Null;

  /** @name PalletParametersModuleCall (347) */
  interface PalletParametersModuleCall extends Enum {
    readonly isChangeRequestLimit: boolean;
    readonly asChangeRequestLimit: {
      readonly requestLimit: u32;
    } & Struct;
    readonly isChangeMaxInstructionsPerPrograms: boolean;
    readonly asChangeMaxInstructionsPerPrograms: {
      readonly maxInstructionsPerPrograms: u64;
    } & Struct;
    readonly isChangeSignersInfo: boolean;
    readonly asChangeSignersInfo: {
      readonly totalSigners: u8;
      readonly threshold: u8;
    } & Struct;
    readonly isChangeAcceptedMrtdValues: boolean;
    readonly asChangeAcceptedMrtdValues: {
      readonly acceptedMrtdValues: Vec<Bytes>;
    } & Struct;
    readonly type: 'ChangeRequestLimit' | 'ChangeMaxInstructionsPerPrograms' | 'ChangeSignersInfo' | 'ChangeAcceptedMrtdValues';
  }

  /** @name PalletOracleModuleCall (348) */
  type PalletOracleModuleCall = Null;

  /** @name PalletAttestationCall (349) */
  ...
  /** @name EntropyRuntimeOriginCaller (350) */
  ...
  /** @name SpCoreSr25519VrfVrfSignature (363) */
  ...
  /** @name PalletTransactionPaymentReleases (393) */
  ...
  /** @name PalletElectionProviderMultiPhaseReadySolution (394) */
  ...
  /** @name PalletElectionProviderMultiPhaseRoundSnapshot (396) */
  interface PalletElectionProviderMultiPhaseRoundSnapshot extends Struct {
    readonly voters: Vec<ITuple<[AccountId32, u64, Vec<AccountId32>]>>;
    readonly targets: Vec<AccountId32>;
  }

  /** @name PalletElectionProviderMultiPhaseSignedSignedSubmission (403) */
  ...
  /** @name PalletElectionProviderMultiPhaseError (404) */
  ...
  /** @name PalletStakingStakingLedger (405) */
  ...
  /** @name PalletStakingNominations (407) */
  ...
  /** @name PalletStakingActiveEraInfo (408) */
  interface PalletStakingActiveEraInfo extends Struct {
    readonly index: u32;
    readonly start: Option<u64>;
  }

  /** @name SpStakingPagedExposureMetadata (411) */
  ...
  /** @name SpStakingExposurePage (413) */
  interface SpStakingExposurePage extends Struct {
    readonly pageTotal: Compact<u128>;
    readonly others: Vec<SpStakingIndividualExposure>;
  }

  /** @name PalletStakingEraRewardPoints (414) */
  interface PalletStakingEraRewardPoints extends Struct {
    readonly total: u32;
    readonly individual: BTreeMap<AccountId32, u32>;
  }

  /** @name PalletStakingUnappliedSlash (419) */
  ...
  /** @name PalletStakingSlashingSlashingSpans (421) */
  ...
  /** @name PalletStakingSlashingSpanRecord (422) */
  ...
  /** @name PalletStakingExtensionStatus (427) */
  interface PalletStakingExtensionStatus extends Enum {
    readonly isPending: boolean;
    readonly isConfirmed: boolean;
    readonly type: 'Pending' | 'Confirmed';
  }

  /** @name PalletStakingExtensionRefreshInfo (429) */
  interface PalletStakingExtensionRefreshInfo extends Struct {
    readonly validatorsInfo: Vec<EntropySharedValidatorInfo>;
    readonly proactiveRefreshKeys: Vec<Bytes>;
  }

  /** @name PalletStakingExtensionNextSignerInfo (430) */
  interface PalletStakingExtensionNextSignerInfo extends Struct {
    readonly nextSigners: Vec<AccountId32>;
    readonly confirmations: Vec<AccountId32>;
  }

  /** @name PalletStakingExtensionReshareInfo (431) */
  interface PalletStakingExtensionReshareInfo extends Struct {
    readonly newSigner: Bytes;
    readonly blockNumber: u32;
  }

  /** @name PalletStakingExtensionJumpStartDetails (432) */
  interface PalletStakingExtensionJumpStartDetails extends Struct {
    readonly jumpStartStatus: PalletStakingExtensionJumpStartStatus;
    readonly confirmations: Vec<AccountId32>;
    readonly verifyingKey: Option<Bytes>;
    readonly parentKeyThreshold: u8;
  }

  /** @name PalletStakingExtensionJumpStartStatus (433) */
  interface PalletStakingExtensionJumpStartStatus extends Enum {
    readonly isReady: boolean;
    readonly isInProgress: boolean;
    readonly asInProgress: u32;
    readonly isDone: boolean;
    readonly type: 'Ready' | 'InProgress' | 'Done';
  }

  /** @name PalletStakingExtensionError (435) */
  interface PalletStakingExtensionError extends Enum {
    ...
    readonly isTssAccountAlreadyExists: boolean;
    readonly isNotNextSigner: boolean;
    readonly isReshareNotInProgress: boolean;
    readonly isAlreadyConfirmed: boolean;
    readonly isTooManyPendingAttestations: boolean;
    readonly isNoUnbondingWhenSigner: boolean;
    readonly isNoUnbondingWhenNextSigner: boolean;
    readonly isNoUnnominatingWhenSigner: boolean;
    readonly isNoUnnominatingWhenNextSigner: boolean;
    readonly isNoChangingThresholdAccountWhenSigner: boolean;
    readonly type: 'EndpointTooLong' | 'NoBond' | 'NotController' | 'NoThresholdKey' | 'InvalidValidatorId' | 'SigningGroupError' | 'TssAccountAlreadyExists' | 'NotNextSigner' | 'ReshareNotInProgress' | 'AlreadyConfirmed' | 'TooManyPendingAttestations' | 'NoUnbondingWhenSigner' | 'NoUnbondingWhenNextSigner' | 'NoUnnominatingWhenSigner' | 'NoUnnominatingWhenNextSigner' | 'NoChangingThresholdAccountWhenSigner';
  }
  ...
  /** @name PalletDemocracyReferendumInfo (446) */
  ...
  /** @name PalletDemocracyReferendumStatus (447) */
  ...
  /** @name PalletDemocracyVoteVoting (449) */
  ...
  /** @name PalletCollectiveVotes (459) */
  ...
  /** @name PalletCollectiveError (460) */
  ...
  /** @name PalletTreasuryProposal (473) */
  ...
  /** @name PalletTreasurySpendStatus (475) */
  ...
  /** @name PalletTreasuryPaymentState (476) */
  ...
  /** @name PalletIdentityRegistration (490) */
  ...
  /** @name PalletIdentityAuthorityProperties (501) */
  ...
  /** @name PalletRecoveryRecoveryConfig (504) */
  ...
  /** @name PalletSchedulerScheduled (515) */
  ...
  /** @name PalletPreimageOldRequestStatus (518) */
  ...
  /** @name PalletPreimageRequestStatus (520) */
  ...
  /** @name PalletMultisigMultisig (536) */
  ...
  /** @name PalletTransactionStorageTransactionInfo (546) */
  ...
  /** @name PalletTransactionStorageError (548) */
  ...
  /** @name PalletBagsListListNode (549) */
  ...
  /** @name PalletBagsListListBag (550) */
  interface PalletBagsListListBag extends Struct {
    readonly head: Option<AccountId32>;
    readonly tail: Option<AccountId32>;
  }

  /** @name PalletBagsListError (552) */
  ...
  /** @name PalletBagsListListListError (553) */
  ...
  /** @name PalletNominationPoolsPoolMember (554) */
  ...
  /** @name PalletNominationPoolsBondedPoolInner (559) */
  ...
  /** @name PalletNominationPoolsCommission (560) */
  ...
  /** @name PalletNominationPoolsPoolRoles (563) */
  ...
  /** @name PalletNominationPoolsRewardPool (564) */
  ...
  /** @name PalletNominationPoolsSubPools (565) */
  ...
  /** @name PalletNominationPoolsUnbondPool (566) */
  interface PalletNominationPoolsUnbondPool extends Struct {
    readonly points: u128;
    readonly balance: u128;
  }

  /** @name PalletNominationPoolsError (572) */
  ...
  /** @name PalletNominationPoolsDefensiveError (573) */
  ...
  /** @name PalletRegistryRegisteredInfo (574) */
  interface PalletRegistryRegisteredInfo extends Struct {
    readonly programsData: Vec<PalletRegistryProgramInstance>;
    readonly programModificationAccount: AccountId32;
  ...
  interface PalletRegistryError extends Enum {
    ...
    readonly isTooManyModifiableKeys: boolean;
    readonly isMismatchedVerifyingKey: boolean;
    readonly isNotValidator: boolean;
    readonly isJumpStartProgressNotReady: boolean;
    readonly isJumpStartNotInProgress: boolean;
    readonly isJumpStartNotCompleted: boolean;
    readonly isNoRegisteringFromParentKey: boolean;
    readonly isInvalidBip32DerivationPath: boolean;
    readonly isBip32AccountDerivationFailed: boolean;
    readonly isNotEnoughValidatorsForJumpStart: boolean;
    readonly isCannotFindValidatorInfo: boolean;
    readonly type: 'NoThresholdKey' | 'NotRegistered' | 'AlreadyConfirmed' | 'IpAddressError' | 'NotAuthorized' | 'NoProgramSet' | 'TooManyModifiableKeys' | 'MismatchedVerifyingKey' | 'NotValidator' | 'JumpStartProgressNotReady' | 'JumpStartNotInProgress' | 'JumpStartNotCompleted' | 'NoRegisteringFromParentKey' | 'InvalidBip32DerivationPath' | 'Bip32AccountDerivationFailed' | 'NotEnoughValidatorsForJumpStart' | 'CannotFindValidatorInfo';
  }

  /** @name PalletProgramsProgramInfo (579) */
  interface PalletProgramsProgramInfo extends Struct {
  ...
  /** @name PalletProgramsError (581) */
  interface PalletProgramsError extends Enum {
    readonly isNotAuthorized: boolean;
    ...
    readonly type: 'NotAuthorized' | 'ProgramLengthExceeded' | 'NoProgramDefined' | 'ProgramAlreadySet' | 'TooManyProgramsOwned' | 'ProgramInUse' | 'ArithmeticError';
  }

  /** @name PalletTransactionPauseModuleError (582) */
  ...
  /** @name PalletParametersModuleError (583) */
  interface PalletParametersModuleError extends Enum {
    readonly isThresholdGreaterThenSigners: boolean;
    readonly isThrehsoldTooLow: boolean;
    readonly isTooManySigners: boolean;
    readonly isSignerDiffTooLarge: boolean;
    readonly isOneChangePerSession: boolean;
    readonly type: 'ThresholdGreaterThenSigners' | 'ThrehsoldTooLow' | 'TooManySigners' | 'SignerDiffTooLarge' | 'OneChangePerSession';
  }

  /** @name PalletOracleModuleError (586) */
  type PalletOracleModuleError = Null;

  /** @name PalletAttestationError (587) */
  interface PalletAttestationError extends Enum {
    readonly isBadQuote: boolean;
    readonly isUnexpectedAttestation: boolean;
    readonly isIncorrectInputData: boolean;
    readonly isNoX25519KeyForAccount: boolean;
    readonly isNoPCKForAccount: boolean;
    readonly isBadMrtdValue: boolean;
    readonly isCannotDecodeVerifyingKey: boolean;
    readonly isPckVerification: boolean;
    readonly type: 'BadQuote' | 'UnexpectedAttestation' | 'IncorrectInputData' | 'NoX25519KeyForAccount' | 'NoPCKForAccount' | 'BadMrtdValue' | 'CannotDecodeVerifyingKey' | 'PckVerification';
  }
  ...
  /** @name EntropyRuntimeRuntime (598) */
