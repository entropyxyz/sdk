...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    attestation: {
       ...
       **/
      attestationRequests: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<Vec<Bytes>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * A map of TSS Account ID to quote nonce for pending attestations
       **/
      pendingAttestations: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<U8aFixed>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
    ...
    oracle: {
      oracleData: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<Option<Bytes>>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    parameters: {
       ...
       **/
      acceptedMrtdValues: AugmentedQuery<ApiType, () => Observable<Vec<Bytes>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The max instructions all programs can have
       **/
      maxInstructionsPerPrograms: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The request limit a user can ask to a specific set of TSS in a block
       **/
      requestLimit: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The size of the signers and their threshold
       **/
      signersInfo: AugmentedQuery<ApiType, () => Observable<PalletParametersModuleSignersSize>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    registry: {
       ...
       * Counter for the related counted storage map
       **/
      counterForRegistered: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      jumpstartDkg: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<EntropySharedValidatorInfo>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Mapping of program_modification accounts to verifying keys they can control
       **/
      modifiableKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Vec<Bytes>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      registered: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<Option<PalletRegistryRegisteredInfo>>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    slashing: {
       ...
       **/
      failedRegistrations: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<u32>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    stakingExtension: {
       ...
       * Counter for the related counted storage map
       **/
      counterForValidationQueue: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      jumpStartProgress: AugmentedQuery<ApiType, () => Observable<PalletStakingExtensionJumpStartDetails>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The next signers ready to take the Signers place when a reshare is done
       **/
      nextSigners: AugmentedQuery<ApiType, () => Observable<Option<PalletStakingExtensionNextSignerInfo>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      reshareData: AugmentedQuery<ApiType, () => Observable<PalletStakingExtensionReshareInfo>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Tell Signers to rotate keyshare
       **/
      rotateKeyshares: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Current validators in the network that hold the parent key and are expected to sign
       **/
      signers: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       * `AccountId`.
       **/
      validationQueue: AugmentedQuery<ApiType, (arg1: PalletStakingExtensionStatus | 'Pending' | 'Confirmed' | number | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<ITuple<[AccountId32, PalletStakingExtensionServerInfo]>>>, [PalletStakingExtensionStatus, AccountId32]> & QueryableStorageEntry<ApiType, [PalletStakingExtensionStatus, AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
