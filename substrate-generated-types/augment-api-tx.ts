...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    programs: {
       ...
       **/
      setProgram: AugmentedSubmittable<(newProgram: Bytes | string | Uint8Array, configurationSchema: Bytes | string | Uint8Array, auxiliaryDataSchema: Bytes | string | Uint8Array, oracleDataPointer: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes, Bytes, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    registry: {
       ...
       **/
      pruneRegistration: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      /**
       * See [`Pallet::register`].
       **/
      register: AugmentedSubmittable<(programModificationAccount: AccountId32 | string | Uint8Array, keyVisibility: EntropySharedKeyVisibility | { Public: any } | { Private: any } | string | Uint8Array, programsData: Vec<PalletRegistryProgramInstance> | (PalletRegistryProgramInstance | { programPointer?: any; programConfig?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [AccountId32, EntropySharedKeyVisibility, Vec<PalletRegistryProgramInstance>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
