...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    attestation: {
       ...
       * See [`Pallet::attest`].
       **/
      attest: AugmentedSubmittable<(quote: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes]>;
      /**
       * Generic tx
       **/
    ...
    parameters: {
      /**
       * See [`Pallet::change_accepted_mrtd_values`].
       **/
      changeAcceptedMrtdValues: AugmentedSubmittable<(acceptedMrtdValues: Vec<Bytes> | (Bytes | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<Bytes>]>;
      /**
       * See [`Pallet::change_max_instructions_per_programs`].
       **/
      changeMaxInstructionsPerPrograms: AugmentedSubmittable<(maxInstructionsPerPrograms: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64]>;
      /**
       * See [`Pallet::change_request_limit`].
       **/
      changeRequestLimit: AugmentedSubmittable<(requestLimit: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      /**
       * See [`Pallet::change_signers_info`].
       **/
      changeSignersInfo: AugmentedSubmittable<(totalSigners: u8 | AnyNumber | Uint8Array, threshold: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u8, u8]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    programs: {
       ...
       **/
      setProgram: AugmentedSubmittable<(newProgram: Bytes | string | Uint8Array, configurationSchema: Bytes | string | Uint8Array, auxiliaryDataSchema: Bytes | string | Uint8Array, oracleDataPointer: Bytes | string | Uint8Array, versionNumber: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes, Bytes, Bytes, u8]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    registry: {
       ...
       **/
      changeProgramInstance: AugmentedSubmittable<(verifyingKey: Bytes | string | Uint8Array, newProgramInstance: Vec<PalletRegistryProgramInstance> | (PalletRegistryProgramInstance | { programPointer?: any; programConfig?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Bytes, Vec<PalletRegistryProgramInstance>]>;
      /**
       * See [`Pallet::change_program_modification_account`].
       **/
      changeProgramModificationAccount: AugmentedSubmittable<(verifyingKey: Bytes | string | Uint8Array, newProgramModAccount: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, AccountId32]>;
      /**
       * See [`Pallet::confirm_jump_start`].
       **/
      confirmJumpStart: AugmentedSubmittable<(verifyingKey: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes]>;
      /**
       * See [`Pallet::jump_start_network`].
       **/
      jumpStartNetwork: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      /**
       * See [`Pallet::register`].
       **/
      register: AugmentedSubmittable<(programModificationAccount: AccountId32 | string | Uint8Array, programsData: Vec<PalletRegistryProgramInstance> | (PalletRegistryProgramInstance | { programPointer?: any; programConfig?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [AccountId32, Vec<PalletRegistryProgramInstance>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    stakingExtension: {
      ...
      chill: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      /**
       * See [`Pallet::confirm_key_reshare`].
       **/
      confirmKeyReshare: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      /**
       ...
       * See [`Pallet::validate`].
       **/
      validate: AugmentedSubmittable<(prefs: PalletStakingValidatorPrefs | { commission?: any; blocked?: any } | string | Uint8Array, serverInfo: PalletStakingExtensionServerInfo | { tssAccount?: any; x25519PublicKey?: any; endpoint?: any; provisioningCertificationKey?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletStakingValidatorPrefs, PalletStakingExtensionServerInfo]>;
      /**
       * See [`Pallet::withdraw_unbonded`].
       **/
      withdrawUnbonded: AugmentedSubmittable<(numSlashingSpans: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
